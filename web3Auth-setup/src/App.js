...
const clientId = "BHJDfT4SGwyWgF0Zl5ySL4wjDqLfw9m_zHiC6rQZsfp9Aw0oLxwDO5MiD9C8U1ezCV7Sd3lmjJNV29kebpwqT_0"; // get from https://dashboard.web3auth.io
  ...
  return (
    ...
    >
      <h3 style={{ textAlign: "center", marginTop: 10 }}>
        Blockchain for Correction of Corruption
      </h3>
      <br></br>
      <br></br>
          ...
          <div className="col-md-8">
            <div style={styles.card}>
              ...
              <h6 style={{ color: "#000000", fontWeight: 300, fontSize: 16 }}>
                Using Web3Auth : For One-Click Login
              </h6>
              <button
                style={{
                  marginTop: 10,
